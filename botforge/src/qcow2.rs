...
mod tests {
    ...
    fn make_multi_l1_source_qcow2(
        ...
        for (guest_cluster, _) in &written_clusters {
            ...
            write_u64_at(&mut file, l2_table_base + l2_idx * 8, data_offset | QCOW_OFLAG_COPIED)
                .unwrap();
        }
    ...
    fn native_compress_multi_l1_data_integrity_zlib() {
        ...
        let (written_clusters, virtual_size) =
            make_multi_l1_source_qcow2(&source, cluster_size, 3);
        assert_qemu_img_check(&source);
        compress_qcow2_image(&source, &compressed, CompressionType::Zlib, &BTreeMap::new(), "")
    ...
    fn native_compress_multi_l1_data_integrity_zstd() {
        ...
        let (written_clusters, virtual_size) =
            make_multi_l1_source_qcow2(&source, cluster_size, 3);
        assert_qemu_img_check(&source);
        compress_qcow2_image(&source, &compressed, CompressionType::Zstd, &BTreeMap::new(), "")
