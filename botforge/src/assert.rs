...
mod tests {
    use super::{
        check_one_path, check_one_service, check_service_environment, normalize_mode, AssertFile,
        AssertFileType, AssertService, ServiceEnvironmentExpect,
    };
    ...
    mod assert_block {
        use super::super::{
            check_service_environment, AssertFileType, ServiceEnvironmentExpect,
        };
...
"#,
        ...
        fn test_check_service_environment_contains_present_passes() {
            ...
            let output =
                "Environment=BOTWORK_LAUNCHER_DEFAULT_NETWORK=botwork-plugin FOO=bar";
